			...
			<!-- Dropdown - User Information -->
				...
				<ul class="nav nav-pills flex-column sidebar-nav">
                    ...
                    if($usuario->id_tipo_usuario == '1'){//OPERADOR
                        echo '<li class="nav-item"><a class="logout-button " href="'.$url_site.'index.php"><em class="fa fa-address-book"></em> Consulta</a></li>
                    <li class="nav-item"><a class="logout-button" href="'. $url_site.'registroingresos/"><em class="fa fa-database"></em> Historial de ingreso</a></li>';
                    }
					if($usuario->id_tipo_usuario == '2'){//SUPERVISOR
                        echo '<li class="nav-item"><a class="logout-button " href="'.$url_site.'index.php"><em class="fa fa-address-book"></em> Consulta</a></li>
					 <li class="nav-item"><a class="logout-button" href="'.$url_site.'registrovehicular/"><em class="fa fa-database"></em> Vehículos registrados</a></li>
                    <li class="nav-item"><a class="logout-button" href="'. $url_site.'registroingresos/"><em class="fa fa-database"></em> Historial de ingreso</a></li>';
				}
					if($usuario->id_tipo_usuario == '3'){ //ADMINISTRADOR
						...
						<li class="nav-item"><a class="logout-button" href="'.$url_site.'registrovehicular/"><em class="fa fa-database"></em> Vehículos registrados</a></li>
					   <li class="nav-item"><a class="logout-button" href="'. $url_site.'registroingresos/"><em class="fa fa-database"></em> Historial de ingreso</a></li>
					   <li class="nav-item"><a class="logout-button" href="'. $url_site.'vehiculo/"><em class="fa fa-database"></em> Gestor de usuarios</a></li>';  
                    }
                    ?>
