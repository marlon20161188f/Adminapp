<nav class="sidebar col-xs-12 col-sm-4 col-lg-3 col-xl-2">
				<h1 class="site-title"><a href="<?php echo $url_site; ?>index2.php"><em class="fa fa-user-circle"></em> ADMIN</a></h1>
													
				<a href="#menu-toggle" class="btn btn-default" id="menu-toggle"><em class="fa fa-tachometer"></em></a>
				<ul class="nav nav-pills flex-column sidebar-nav">
                    <?php
                    if($usuario->id_tipo_usuario == '1'){
                        echo '<li class="nav-item"><a class="nav-link active" href="'.$url_site.'index2.php"><em class="fa fa-address-book"></em> Consulta</a></li>
				...
				<a href="<?php echo $url_site; ?>index.php" class="logout-button"><em class="fa fa-power-off"></em> Cerrar Sesión</a>
</nav>