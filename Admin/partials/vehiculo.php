                                ...
                                ?>
                                    ...
                                    <td><?php echo $item['nombres']; ?></td>
                                        ...
                                        if($item['descripcion'] =="Administrador"){
                                          echo'<td style="text-align: center;"><button id="bn_'.$item['id'].'" class="btn btn-success btnprueba btn-xs" disabled onclick="Cambiar_Estado('.$item['id'].','.$item['id_estado'].')">Activo</button></td>';
                                        }else{
                                        if($item['id_estado']!="1"){
                                            echo'<td style="text-align: center;"><button id="bn_'.$item['id'].'" class="btn btn-danger btnprueba btn-xs" onclick="Cambiar_Estado('.$item['id'].','.$item['id_estado'].')">Inactivo</button></td>';
                                          }else{
                                            echo'<td style="text-align: center;"><button id="bn_'.$item['id'].'" class="btn btn-success btnprueba btn-xs" onclick="Cambiar_Estado('.$item['id'].','.$item['id_estado'].')">Activo</button></td>';
                                          }}?>
                                        <td>
        ...
        <div class="row">
            ...
            <div class="form-group">
                ...
                <div class="col-12 no-padding">
                    <!-- <input type="hidden" name="id" id="id">
                    <input type="hidden" name="option" value="U"> -->
                   <select class="form-control"  name="id_tipo_usuario" id="id_tipo_usuario" placeholder="Elije la descripción del usuario">
